...
\end{align}
$$
However this $p(m)$ is not normalized yet, thus, we should have $\int _0^\infty (p_{normalized}(m))dm = \int _0^\infty (const\cdot p(m) )dm = 1$
...
<img src="/Users/freezer/Basement/2019Fall/Courses/EESC6908/2019_QMDA/HW2_Due0923/image-20190923115421931.png" alt="image-20190923115421931" style="zoom:50%;" />
...
xlabel(sprintf('P(have Strep Throat)'));
ylabel('P(have Strep Throat | Got the results)');
```
